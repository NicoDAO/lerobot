...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set DIR_MOTEUR1 [ create_bd_port -dir O DIR_MOTEUR1 ]
  ...
  set clk_gyr_pmod_0 [ create_bd_port -dir O clk_gyr_pmod_0 ]
  set cs_gyro_pmod_0 [ create_bd_port -dir O cs_gyro_pmod_0 ]
  ...
  set int1_gyro_pmod_0 [ create_bd_port -dir I int1_gyro_pmod_0 ]
  set int2_gyro_pmod_0 [ create_bd_port -dir I int2_gyro_pmod_0 ]
  set s_pwm [ create_bd_port -dir O -from 0 -to 0 s_pwm ]
  set sck_mic_0 [ create_bd_port -dir O sck_mic_0 ]
  set sdi_gyro_pmod_0 [ create_bd_port -dir I sdi_gyro_pmod_0 ]
  set sdi_mic_0 [ create_bd_port -dir I sdi_mic_0 ]
  set sdo_gyro_pmod_0 [ create_bd_port -dir O sdo_gyro_pmod_0 ]
  set shd_ampli_0 [ create_bd_port -dir O shd_ampli_0 ]
  set sortie_pwm_0 [ create_bd_port -dir O sortie_pwm_0 ]
  set sortie_pwm_1 [ create_bd_port -dir O sortie_pwm_1 ]
  set sortie_trig_0 [ create_bd_port -dir O sortie_trig_0 ]

  # Create instance: FIR_0, and set properties
  set FIR_0 [ create_bd_cell -type ip -vlnv user.org:user:FIR:1.0 FIR_0 ]
  set_property -dict [ list \
   CONFIG.numero {0} \
 ] $FIR_0

  # Create instance: FIR_1, and set properties
  set FIR_1 [ create_bd_cell -type ip -vlnv user.org:user:FIR:1.0 FIR_1 ]
  set_property -dict [ list \
   CONFIG.numero {1} \
 ] $FIR_1

  # Create instance: FIR_2, and set properties
  set FIR_2 [ create_bd_cell -type ip -vlnv user.org:user:FIR:1.0 FIR_2 ]
  set_property -dict [ list \
   CONFIG.numero {0} \
 ] $FIR_2

  # Create instance: FIR_3, and set properties
  set FIR_3 [ create_bd_cell -type ip -vlnv user.org:user:FIR:1.0 FIR_3 ]
  set_property -dict [ list \
   CONFIG.numero {0} \
 ] $FIR_3

  # Create instance: GyrocsopeSPI_0, and set properties
  set GyrocsopeSPI_0 [ create_bd_cell -type ip -vlnv user.org:user:capteurDistance:1.0 GyrocsopeSPI_0 ]

  # Create instance: PmodMIC3_0, and set properties
  set PmodMIC3_0 [ create_bd_cell -type ip -vlnv moi.org:user:PmodMIC3:1.2 PmodMIC3_0 ]

  # Create instance: gainNvoies_0, and set properties
  set gainNvoies_0 [ create_bd_cell -type ip -vlnv user.org:user:gainNvoies:1.1 gainNvoies_0 ]

  # Create instance: interface_DAC8551_1, and set properties
  set interface_DAC8551_1 [ create_bd_cell -type ip -vlnv user.org:user:interface_DAC8551:1.1 interface_DAC8551_1 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ {62} \
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {20} \
   CONFIG.PCW_ACT_FPGA2_PERIPHERAL_FREQMHZ {20} \
   CONFIG.PCW_ACT_FPGA3_PERIPHERAL_FREQMHZ {100} \
   ...
   CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {0.1} \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} \
   CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#gpio[16]#gpio[17]#gpio[18]#gpio[19]#gpio[20]#gpio[21]#gpio[22]#gpio[23]#gpio[24]#gpio[25]#gpio[26]#gpio[27]#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#gpio[46]#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins pmod_audio_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins FIR_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins pmod_audio_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins FIR_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  ...
  connect_bd_net -net FIR_0_s00_sortie_fir [get_bd_pins FIR_0/s00_sortie_fir] [get_bd_pins gainNvoies_0/audio_in_1]
  connect_bd_net -net FIR_0_s00_traitement_fini [get_bd_pins FIR_0/s00_traitement_fini] [get_bd_pins gainNvoies_0/audio_in_1_pret]
  connect_bd_net -net FIR_1_s00_sortie_fir [get_bd_pins FIR_1/s00_sortie_fir] [get_bd_pins gainNvoies_0/audio_in_2]
  connect_bd_net -net FIR_1_s00_traitement_fini [get_bd_pins FIR_1/s00_traitement_fini] [get_bd_pins gainNvoies_0/audio_in_2_pret]
  connect_bd_net -net FIR_2_s00_sortie_fir [get_bd_pins FIR_2/s00_sortie_fir] [get_bd_pins gainNvoies_0/audio_in_3]
  connect_bd_net -net FIR_2_s00_traitement_fini [get_bd_pins FIR_2/s00_traitement_fini] [get_bd_pins gainNvoies_0/audio_in_3_pret]
  connect_bd_net -net FIR_3_s00_sortie_fir [get_bd_pins FIR_3/s00_sortie_fir] [get_bd_pins gainNvoies_0/audio_in_4]
  connect_bd_net -net FIR_3_s00_traitement_fini [get_bd_pins FIR_3/s00_traitement_fini] [get_bd_pins gainNvoies_0/audio_in_4_pret]
  connect_bd_net -net GyrocsopeSPI_0_sortie_trig [get_bd_ports sortie_trig_0] [get_bd_pins GyrocsopeSPI_0/sortie_trig]
  connect_bd_net -net PmodMIC3_0_audio_out [get_bd_pins FIR_0/s00_entree_fir] [get_bd_pins FIR_1/s00_entree_fir] [get_bd_pins FIR_2/s00_entree_fir] [get_bd_pins FIR_3/s00_entree_fir] [get_bd_pins PmodMIC3_0/audio_out]
  ...
  connect_bd_net -net gainNvoies_0_audio_out_3 [get_bd_pins gainNvoies_0/audio_out_3] [get_bd_pins melangeur_0/audio_in_3]
  connect_bd_net -net gainNvoies_0_audio_out_4 [get_bd_pins gainNvoies_0/audio_out_4] [get_bd_pins melangeur_0/audio_in_4]
  connect_bd_net -net gainNvoies_0_sortie_out_1_pret [get_bd_pins gainNvoies_0/sortie_out_1_pret] [get_bd_pins melangeur_0/audio_valid_in_1]
  connect_bd_net -net gainNvoies_0_sortie_out_2_pret [get_bd_pins gainNvoies_0/sortie_out_2_pret] [get_bd_pins melangeur_0/audio_valid_in_2]
  ...
  connect_bd_net -net int1_gyro_pmod_0_1 [get_bd_ports int1_gyro_pmod_0] [get_bd_pins mongyrocopse_0/int1_gyro_pmod]
  connect_bd_net -net int2_gyro_pmod_0_1 [get_bd_ports int2_gyro_pmod_0] [get_bd_pins mongyrocopse_0/int2_gyro_pmod]
  ...
  connect_bd_net -net mongyrocopse_0_clk_gyr_pmod [get_bd_ports clk_gyr_pmod_0] [get_bd_pins mongyrocopse_0/clk_gyr_pmod]
  connect_bd_net -net mongyrocopse_0_cs_gyro_pmod [get_bd_ports cs_gyro_pmod_0] [get_bd_pins mongyrocopse_0/cs_gyro_pmod]
  connect_bd_net -net mongyrocopse_0_sdo_gyro_pmod [get_bd_ports sdo_gyro_pmod_0] [get_bd_pins mongyrocopse_0/sdo_gyro_pmod]
  ...
  connect_bd_net -net sdi_gyro_pmod_0_1 [get_bd_ports sdi_gyro_pmod_0] [get_bd_pins mongyrocopse_0/sdi_gyro_pmod]
  connect_bd_net -net sdi_mic_0_1 [get_bd_ports sdi_mic_0] [get_bd_pins PmodMIC3_0/sdi_mic]

  # Create address segments
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs FIR_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x43C20000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs FIR_1/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x43C30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs FIR_2/S00_AXI/S00_AXI_reg] -force
