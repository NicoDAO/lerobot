...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = FIR
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = FIR_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = FIR
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = FIR_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = FIR
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = FIR_3
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gainNvoies
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = gainNvoies_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = pmod_audio
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = pmod_audio_0
END
