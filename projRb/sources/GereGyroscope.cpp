...
void GereGyroscope::handler() {
	...
	case gyro_tourne:
		...
		switch(etat){
			case 0:
				Xil_Out32(this->adresseAXI, 255, 0x1 ); //on lit la valeur X  
				Xil_Out32(this->adresseAXI, 0, 2 ); //on lit la valeur X 
				Xil_Out32(this->adresseAXI, 0x20,3 ); //on lit la valeur X
				Xil_Out32(this->adresseAXI, 187,1 ); //on lit la valeur X
			...
			case 1:
				Xil_Out32(this->adresseAXI, 255, 0x1 ); //on lit la valeur X  
				Xil_Out32(this->adresseAXI, 0, 2 ); //on lit la valeur X 
				Xil_Out32(this->adresseAXI, 0x28,3 ); //on lit la valeur X
				Xil_Out32(this->adresseAXI, 187,1 ); //on lit la valeur X
			...
			case 2:
				Xil_Out32(this->adresseAXI, 255, 0x1 ); //on lit la valeur X  
				Xil_Out32(this->adresseAXI, 0, 2 ); //on lit la valeur X 
				Xil_Out32(this->adresseAXI, 0x29,3 ); //on lit la valeur X
				Xil_Out32(this->adresseAXI, 187,1 ); //on lit la valeur X
		                lecture3 = 0xff & Xil_In32(this->adresseAXI  ); //lit la valeur du registre
				calog.log_gyro("%02x   %02x    %02x ",lecture1, lecture2, lecture3);
				//etat = 0;
			break;
		}
	break;
